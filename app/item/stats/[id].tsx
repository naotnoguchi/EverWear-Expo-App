          ...
          <View style={styles.efficiencyContainer}>
            <View style={styles.efficiencyMeter}>
              ...
              <View style={styles.efficiencyScale}>
                <Text style={[styles.efficiencyScaleText, { color: theme.text + "99" }]}>低</Text>
                <Text style={[styles.efficiencyScaleText, { color: theme.text + "99" }]}>最適</Text>
                <Text style={[styles.efficiencyScaleText, { color: theme.text + "99" }]}>高</Text>
              </View>
            </View>

            <Text style={[styles.efficiencyDescription, { color: theme.text }]}>
            ...
            <View style={styles.efficiencyTip}>
              ...
              <Text style={[styles.tipText, { color: theme.text + "CC" }]}>
        ...
        <View style={[styles.card, { backgroundColor: theme.card }]}>
          ...
          <View style={styles.patternContainer}>
            <View style={styles.patternItem}>
              <Text style={[styles.patternLabel, { color: theme.text + "99" }]}>
                最も着用する曜日
              </Text>
              {mostWornDay ? (
        ...
        <View style={[styles.card, { backgroundColor: theme.card }]}>
          ...
          <View style={styles.impactContainer}>
            <View style={styles.impactItem}>
              ...
              <Text style={[styles.impactLabel, { color: theme.text + "99" }]}>
                節水量
              </Text>
            </View>
